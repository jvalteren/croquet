...
// ignore-in-doc
var classHelper = lang.classHelper = {
  ...
  addPins: function(cls, spec) {
    ...
    function needsSetter(name) { return !lang.string.startsWith(name, '-') };
    function needsGetter(name) { return !lang.string.startsWith(name, '+') };
    var mixinSpec = {};
...
lang.klass = lang.class = {
  ...
  create: function(/*... */) {
    ...
    if (className && targetScope[shortName] && (targetScope[shortName].superclass === superclass)) {
      ...
      klass.toString = function() {
        var initCategory = lang.arr.detect(
    ...
    lang.klass.addMethods.apply(Global, [klass].concat(args));
  ...
  addMethods: function(/*...*/) {
    ...
    for (var i = 1; i < args.length; i++) {
      if (typeof args[i] === 'string') {
        ...
        lang.klass.addCategorizedMethods(klass, category,
  ...
  addCategorizedMethods: function(klass, categoryName, source) {
    ...
    for (var property in source) {
      ...
      var hasSuperCall = ancestor && typeof value === 'function' &&
          lang.fun.argumentNames(value)[0] == "$super";
      if (hasSuperCall) {
        ...
        (function() {
          ...
          var advice = (function(m) {
            var cs = function callSuper() {
              ...
              if (!method) {
                throw new Error(lang.string.format('Trying to call super of' +
          ...
          value = lang.obj.extend(lang.fun.wrap(advice, method), {
  ...
  isSubclassOf: function(klassA, klassB) {
    ...
    return lang.klass.superclasses(klassA).indexOf(klassB) > -1;
  },
  ...
  superclasses: function(klass) {
    ...
    return lang.klass.superclasses(klass.superclass).concat([klass.superclass]);
  },
...
Function.prototype.subclass = function subclass(/*args*/) {
  return lang.klass.create.apply(null, [this].concat(Array.from(arguments)));
}
