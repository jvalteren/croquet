...
arcos is an operative system providing an Immersive Analytics platform that allows the user to very easily view and control 3D data sets as well as define new visualizations based on those datasets.
